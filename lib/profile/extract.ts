/**
 * Resume/profile extraction — heuristic extraction of structured fields from
 ...
 * It will NOT get everything right — it surfaces likely values for the user to
